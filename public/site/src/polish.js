...
export function openCommandPalette() {
  ...
  const commands = [
    ...
    { group: "Appearance", icon: "☀", title: "Switch to Light Mode", desc: "Crisp paper canvas with dark typography (Default)", badge: "☀", action: () => { document.querySelector('[data-set-theme="light"]')?.click() || (document.documentElement.dataset.theme = "light", localStorage.setItem("cx_theme", "light"), localStorage.setItem("cx_theme_user_set", "true")); showToast("Interface theme set to Light Mode", "action"); } },
    { group: "Appearance", icon: "☾", title: "Switch to Dark Mode", desc: "Obsidian low-light canvas for color grading", badge: "☾", action: () => { document.querySelector('[data-set-theme="dark"]')?.click() || (document.documentElement.dataset.theme = "dark", localStorage.setItem("cx_theme", "dark"), localStorage.setItem("cx_theme_user_set", "true")); showToast("Interface theme set to Dark Mode", "action"); } }
  ];
