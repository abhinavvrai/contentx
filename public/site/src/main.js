...
import { enhanceDashboard, enhanceMarketing, enhanceProject, enhanceReview, initTheme, renderAdmin, renderCheckout, selectCheckoutPlan } from "./features.js?v=pricing-longform-1";
...
import { enhanceCreatorTools } from "./creator-tools.js?v=pricing-longform-1";
import { enhanceUploadAdmin, renderClientUpload } from "./uploads.js?v=team-controls-1";
import { accountUser, refreshAccountSession, rememberProtectedRoute, renderAccountAccess, renderAccountDashboard, renderProjectBrief } from "./account.js?v=pricing-longform-1";
import { renderClientWorkspace, renderSharedWorkspace } from "./workspace.js?v=pricing-longform-1";
