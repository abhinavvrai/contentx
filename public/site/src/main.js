...
import { enhanceDashboard, enhanceMarketing, enhanceProject, enhanceReview, initTheme, renderAdmin, renderCheckout, selectCheckoutPlan } from "./features.js?v=monthly-currency-1";
...
import { enhanceCreatorTools } from "./creator-tools.js?v=monthly-currency-1";
import { enhanceUploadAdmin, renderClientUpload } from "./uploads.js?v=team-controls-1";
import { accountUser, refreshAccountSession, rememberProtectedRoute, renderAccountAccess, renderAccountDashboard, renderProjectBrief } from "./account.js?v=monthly-currency-1";
import { renderClientWorkspace, renderSharedWorkspace } from "./workspace.js?v=monthly-currency-1";
