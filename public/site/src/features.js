...
export async function renderAdmin(root, actions) {
  ...
  root.querySelector(".admin-shell>aside>div")?.insertAdjacentHTML("beforeend", '<button data-owner-theme>◐ Light / dark</button><button data-owner-lock>⌾ Lock owner session</button>');
