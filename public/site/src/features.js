...
function setupUnifiedPricing(pricing, actions, data) {
  const packages = {
    video: [
      { id:"basic_reel", name:"Basic", price:1500, tag:"BUDGET · UP TO 1 MIN", delivery:"3-day delivery", revisions:"1 revision", summary:"Clean short-form editing with engaging branded captions.", includes:["1 video up to 60 seconds", "Clean cuts, pacing and zooms", "Branded captions and subtitles", "Colour and audio balancing", "1080p social export", "Source file included"], unavailable:["B-roll and sound design", "Motion graphics", "Advanced motion graphics"] },
      { id:"growth_reel", name:"Standard", price:2500, tag:"SOCIAL PRO · UP TO 90 SEC", delivery:"4-day delivery", revisions:"2 revisions", featured:true, summary:"An attention-led social edit with richer visuals and designed sound.", includes:["1 video up to 90 seconds", "Up to 5 relevant B-roll inserts", "Music, sound design and timed SFX", "Branded captions and subtitles", "Colour and audio balancing", "Source file included"], unavailable:["Custom motion graphics", "Advanced motion graphics"] },
      { id:"advanced_reel", name:"Premium", price:5000, tag:"SIGNATURE · UP TO 3 MIN", delivery:"5-day priority", revisions:"3 revisions", summary:"A campaign-ready hero edit with custom motion and deeper visual storytelling.", includes:["1 video up to 180 seconds", "Up to 10 relevant B-roll inserts", "Full sound design and premium mix", "Custom motion graphics and callouts", "Advanced motion graphics", "Premium colour finish", "Source file included"], unavailable:[] },
    ],
    podcast: [
  ...
  const addOns = {
    video: [
      { id:"broll_sfx", name:"B-roll + Sound Design", price:500, copy:"Add up to 5 relevant B-roll inserts, music accents and timed sound effects." },
      { id:"motion_graphics", name:"Motion Graphics", price:1000, copy:"Animated callouts, titles, icons and branded graphic movement." },
      { id:"advanced_motion_graphics", name:"Advanced Motion Graphics", price:2500, copy:"Custom-designed animated scenes, tracked graphics and premium transitions." },
