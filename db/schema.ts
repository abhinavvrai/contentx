...
export const projectShareLinks = sqliteTable(
  "project_share_links",
  {
    ...
    allowApproval: integer("allow_approval", { mode: "boolean" }).notNull().default(true),
    allowPreviousVersions: integer("allow_previous_versions", { mode: "boolean" }).notNull().default(true),
    assetScopeJson: text("asset_scope_json").notNull().default("[]"),
