...
test("keeps the live shell and site module versions in sync", async () => {
  ...
  assert.match(page, /\/site\/index\.html\?v=frame-native-19/);
  assert.match(html, /contentx-release" content="frame-native-19/);
  assert.match(html, /main\.js\?v=frame-native-19/);
  ...
  assert.match(main, /account\.js\?v=frame-native-19/);
  assert.match(main, /ui\.js\?v=frame-native-19/);
});
