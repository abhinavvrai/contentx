...
test("keeps the live shell and site module versions in sync", async () => {
  ...
  assert.match(html, /contentx-release" content="frame-native-20-production-ready-5/);
  assert.match(html, /main\.js\?v=frame-native-20-production-ready-5/);
  assert.match(html, /commerce\.css\?v=frame-native-20-owner-drilldown-1/);
  assert.match(html, /theme\.css\?v=complete-light-4/);
  assert.match(main, /features\.js\?v=frame-native-20-production-ready-5/);
